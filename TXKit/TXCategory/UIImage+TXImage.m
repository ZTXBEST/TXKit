...
//高效添加圆角图片
- (UIImage*)tx_imageAddCornerWithRadius:(CGFloat)radius andSize:(CGSize)size{
...
//截屏
+(instancetype)tx_snapshotCurrentScreen{
...
+(UIImage *)tx_GetRoundImagewithImage:(UIImage *)image {
...
- (UIImage *)tx_imageWithTitle:(NSString *)title fontSize:(CGFloat)fontSize titleColor:(UIColor *)titleColor {
    //画布大小
