...
#import "UIControl+TXControl.h"
#import <objc/runtime.h>
@implementation UIControl (TXControl)
...
- (void)handleControlEvent:(UIControlEvents)event withBlock:(void(^)(id sender))block {
    ...
    NSString * name = [UIControl getOperationNameWithEvent:UIControlEventTouchUpInside];
